...
/**
 * Created by novalbayusetiawan on 12/22/2016.
 */
...
public class RecyclerViewFragment extends Fragment {
    ...
    DatabaseReference rekam_medis = database.getReference("rekam_medis").child("");
    ...
    private void initDataset() {
        mDataset = new String[status.length];
        mDataset2 = new String[tanggal.length];
        for (int i = 0; i < status.length; i++) {
            mDataset[i] = status[i];
            mDataset2[i] = tanggal[i];
        }
    }
}
